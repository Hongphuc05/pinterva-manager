...
class SupportCompareCandidate(Base):
    """A historical image candidate awaiting optional Support review."""
    ...
    id: Mapped[uuid.UUID] = mapped_column(primary_key=True)
    comparison_item_id: Mapped[uuid.UUID] = mapped_column(nullable=False)
    historical_job_id: Mapped[uuid.UUID | None] = mapped_column(nullable=True)
    historical_asset_id: Mapped[uuid.UUID] = mapped_column(nullable=False)
    ...
    decided_by_id: Mapped[uuid.UUID | None] = mapped_column(nullable=True)
